...
Based on the user's provided information about a person - {information}, I want you to create the following: 
1. A short summary
...
response = chain.invoke({"information": user_information})
